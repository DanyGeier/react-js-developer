...
const Contador = () => {
  ...
  return (
    <>
        ...
        <button className="bg-yellow-500 hover:bg-yellow-600 rounded px-4 py-2 cursor-pointer 
        me-2">Decrementar</button>
        <button className="bg-red-500 hover:bg-yellow-600 rounded px-4 py-2 cursor-pointer ">Reiniciar</button>
    </>
  )
}
