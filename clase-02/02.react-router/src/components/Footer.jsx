    ...
    <footer className="bg-slate-900 border-t border-slate-800 text-white">
        <div className="mx-auto max-w-7xl px-6 py-10">
            ...
            <div className="grid gap-8 md:grid-cols-3">
                ...
                {/* Logo y descripción */}
                <div>
                    <h2 className="text-2xl font-bold text-cyan-400">Mi Sitio</h2>

                    <p className="mt-4 text-sm text-slate-400 leading-6">Ofrecemos productos y servicios de calidad para ayudarte a alcanzar tus objetivos con soluciones modernas y confiables.</p>
                </div>
