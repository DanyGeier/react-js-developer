...
const Contador = ({ valorInicial:vi }) => {
    ...
    // * Ganchos -> builtin. (Están dentro de la libreria de react)
    ...
    //console.log(contador) // arrayDosPosiciones[0]
    //console.log(setContador) // arrayDosPosiciones[1]
    ...
    const handleDecrementar = () => {
        setContador(contador - 1) // ! SIEMPRE USO PARA MODIFICAR EL ESTADO LA FUNCIÓN QUE ME DEVUELVE USESTATE
    }
  ...
  return (
    <>
        ...
        {/* <button 
            ...
            className="bg-blue-500 hover:bg-yellow-600 rounded px-4 py-2 cursor-pointer me-2">Incrementar
        </button> */}
        <button 
        ...
        <button 
            ...
            className="bg-yellow-500 hover:bg-yellow-600 rounded px-4 py-2 cursor-pointer 
            me-2">Decrementar</button>
        <button 
            onClick={handleReiniciar}
            className="bg-red-500 hover:bg-yellow-600 rounded px-4 py-2 cursor-pointer ">Reiniciar</button>
    </>
  )
}
